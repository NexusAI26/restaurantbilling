...
Public Class frm_BillPrint
    ...
    Sub load_reportPrint()
        ...
        Try
            ...
            ' ReportViewer1.LocalReport.ReportPath = ""C:\Users\pratik\Desktop\restaurantbilling-main\FastFoodKitchen\Fast Food Restaurant\Fast Food Restaurant\Report1.rdlc""
            ReportViewer1.LocalReport.DataSources.Clear()
